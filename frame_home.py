...
class Home(customtkinter.CTkFrame):
    def __init__(self, master, navigate_to_page):
        ...
        button_frame = customtkinter.CTkFrame(main_frame, fg_color='transparent')
        button_frame.pack()
        button = customtkinter.CTkButton(button_frame, text="SISTEMA LOTTO", font=("Helvetica", 18, "bold"), width=660, height=120, fg_color='white', hover_color="#53D2FF", text_color="#363636")
        button.pack(side='left', padx=8, pady=8)
